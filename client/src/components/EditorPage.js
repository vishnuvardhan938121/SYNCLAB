      ...
      <div className="row flex-grow-1">
        ...
        >
          <img
            ...
            style={{ maxWidth: "100px", marginTop: "-43px" }}
          />
          <hr style={{ marginTop: "-3rem", borderColor: "#555" }} />

          {/* Client list */}
          <div className="d-flex flex-column flex-grow-1 overflow-auto">
            <span className="mb-2 fw-bold">Members</span>
            {clients.map((client) => (
        ...
        >
          {/* Language selector */}
          <div className="p-2 d-flex justify-content-end bg-black">
            <select
